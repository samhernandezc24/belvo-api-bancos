...
namespace API.Belvo.Services
{
    internal sealed class CuentasService : IGlobal<Cuenta>
    {
        ...
        public async Task Create(dynamic data)
        {
            ...
            //objModel.CreditoLimite                      = accountData.credit_data?.credit_limit ?? 0;            
            //objModel.CreditoCuttingFecha                = accountData.credit_data.cutting_date;
            //objModel.CreditoTasaInteres                 = accountData.credit_data?.interest_rate ?? 0;
            ...
            //objModel.CreditoPagoMinimo                  = accountData.credit_data?.minimum_payment ?? 0;
            ...
            //objModel.FondosIdentificacionPublicaJson    = JsonConvert.SerializeObject(accountData.funds_data.public_identifications);
            ...
            //objModel.PrestamoCuttingFecha               = accountData.loan_data?.cutting_date ?? "";
            //objModel.PrestamoDiaCorte                   = accountData.loan_data?.cutting_day ?? "";
            ...
            //objModel.PrestamoLastPaymentFecha           = accountData.loan_data?.last_payment_date ?? "";
            ...
            //objModel.PrestamoSinPagoIntereses           = accountData.loan_data?.no_interest_payment ?? 0;
